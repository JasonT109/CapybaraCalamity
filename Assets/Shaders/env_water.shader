...
Shader "Shader Forge/env_water" {
    Properties {
        ...
        _NormalAmount ("Normal Amount", Float ) = 0.2
        _node_3790 ("node_3790", Color) = (0,0.004158181,1,1)
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 normalLocal = lerp(_node_3790.rgb,lerp(lerp(_WaterNormal_var.rgb,_WaterNormalB_var.rgb,node_1537),node_6377,node_1537),_NormalAmount);
